...
@section('content')
    ...
    <section class="relative py-6 overflow-hidden">
        ...
        <div class="container mx-auto px-5 text-center relative z-10">
            ...
            <p class="text-lg md:text-xl text-black max-w-3xl mx-auto leading-relaxed mb-4">
                {{ $category->description }}
            </p>

            <!-- Product Count -->
            <div class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-2">
            ...
            @if (count($products) > 0)
                <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    @foreach ($products as $product)
                        <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl overflow-hidden transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 hover:border-blue-200"
                            ...
                            <div class="relative h-56 bg-gray-100 overflow-hidden">
                                ...
                                <!-- Category Badge -->
                                <div
                                    class="absolute top-4 left-4 bg-white/80 text-black px-3 py-1 rounded-full text-xs font-bold">
            ...
            @else
                ...
                <div class="text-center py-20">
                    <div class="mb-8">
                        ...
                        <h3 class="text-3xl font-bold text-gray-700 mb-4">Belum Ada Produk</h3>
                        <p class="text-gray-500 text-lg max-w-md mx-auto mb-8">
                            Saat ini belum ada produk yang tersedia di kategori <strong>{{ $category->name }}</strong>.
                        </p>
                        <div class="flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="{{ route('products.index') }}"
                                class="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-4 rounded-xl font-bold text-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                                <i class="fas fa-arrow-left"></i>
                                Lihat Semua Produk
                            </a>
                            <a href="{{ route('home') }}"
                                class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-300 transform hover:scale-105">
