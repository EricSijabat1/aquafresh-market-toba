            ...
            <div class="p-6 md:p-8">
                ...
                @elseif ($order->payment_method === 'cod' && isset($qrCode))
                    <div class="text-center bg-blue-50 p-6 rounded-lg">
                        ...
                        <p class="text-gray-600 mt-2 mb-4">Simpan dan tunjukkan QR Code ini kepada kurir kami saat pengantaran untuk verifikasi dan pembayaran tunai.</p>
                ...
                @else
                    <div class="text-center">
                        <p class="text-gray-600 mb-4">Tim kami akan segera menghubungi Anda via WhatsApp untuk konfirmasi pengiriman.</p>
